...
class CdkLambdaPython311Django(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        name = "cdk-lambda-python-3-11-django"
        description = "CDK Lambda Python 3.11 Django"
        ...
        tags = InfrastructureTags(Environment="prod", Product="Django")
