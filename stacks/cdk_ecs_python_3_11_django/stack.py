...
class CdkEcsFargatePython311Django(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        name = "cdk-ecs-fargate-python-3-11-django"

        # Build the docker image
        image = ecr_assets.DockerImageAsset(
            self,
            f"{construct_id}-EcrImageAsset",
        ...
        tags = InfrastructureTags(Environment="dev", Product="django")
